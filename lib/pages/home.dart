...
// HomePage widget responsible for the main UI.
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      key: _key,
      appBar: CustomAppBar(scaffoldKey: _key, isConnected: isConnected, title: title),
                        ...
                        child: ClipRRect(
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () async {
                              ...
                              await player.play(AssetSource('click-sound.mp3'),
                                  volume: 0.3);
